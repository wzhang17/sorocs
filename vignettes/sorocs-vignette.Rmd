...
Description: A Bayesian nonparametric Dirichlet process mixtures to estimate the receiver operating characteristic (ROC)  surfaces and the associated volume under the surface (VUS), a summary measure similar to the area under the 
 ...
 context of mixture distributions was adopted.The reference paper is:Zhen Chen, Beom Seuk Hwang, (2018) "A Bayesian semiparametric approach to correlated ROC surfaces with stochastic order constraints". Biometrics, 75, 539-550. <doi:10.1111/biom.12997>.
